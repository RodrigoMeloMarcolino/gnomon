...
public record Appointment(
  ...
  public Appointment {
    ...
    idempotencyFingerprint =
        requireFingerprint(idempotencyFingerprint, "idempotency_fingerprint");
  ...
  private static Instant expectedEnd(Instant startAt, int durationMinutes) {
    try {
      ...
      throw new BookingException("validation_error", "appointment interval is out of range");
    }
  }
  ...
  private static String requireTimezone(String value, String field) {
    ...
    try {
      ...
      throw new BookingException("validation_error", field + " must be a valid IANA timezone");
    }
    return normalized;
  }
